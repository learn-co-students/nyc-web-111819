...
Suggestion.create(name: 'Rails is so exciting', slogan: 'Freakin Amped on the Rails', img_url: "https://images.unsplash.com/photo-1540804236945-b6ae24bfe0a9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80")
Suggestion.create(name: 'Marty McPry', slogan: "where we're going we don't need roads...beacuse we have Rails", img_url: "https://www.usajacket.com/wp-content/uploads/2016/11/Back-To-The-Future-Marty-Mcfly-Vest.jpg")
Suggestion.create(name: 'Git Reps', slogan: "Tony's work out plan", img_url: "https://cdn2.vectorstock.com/i/1000x1000/55/61/brawny-brain-with-muscles-lifting-weights-vector-5865561.jpg")
Suggestion.create(name: '111819', slogan: 'Wanna be a mechine gotta talk like a mechine', img_url: "https://cdn.thinglink.me/api/image/792172321598078976/1240/10/scaletowidth")
Suggestion.create(name: 'Array of the Warrior', slogan: 'Learn today so that you may live tomorrow', img_url: "https://images-na.ssl-images-amazon.com/images/I/41T1JaWMyxL._SX356_BO1,204,203,200_.jpg")
...
Suggestion.create(name: 'Friday the 13th', slogan: "dark times", img_url: "https://i.pinimg.com/originals/af/75/ff/af75ff456977c7fb36f44f87d3fa9c40.jpg")
...
# name_bank = ["Meet the Forkers", "ORM&M’s", "Angry Nerds", "Array of the Warrior", "titanic.to_f", "Pry like an Eagle", "Come Sail Array", "Git Reps", "marty McPry", "I believe I can pry", "Gimme the Loop", "Optimize Prime", "POOP"]